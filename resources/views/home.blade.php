                ...
                <div id="top-banner-{{ $country->id }}" class="banner" style="background-image: url('{{ asset('assets/images/'.$country->image.'') }}')">
                    <div class="banner-inner-wrapper header-text">
                        <div class="main-caption">
                            <h2>@lang('message.f_title')</h2>
                            <h1>{{ $country->name }}</h1>
                            <div class="border-button"><a href="{{ route('traveling.about', $country->id) }}">@lang('message.f_button1')</a></div>
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-6 col-6">
                                                <div class="main-button">
                                                    <a href="{{ route('traveling.about', $country->id) }}">@lang('message.f_button2')</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="section-heading">
                    <h2>@lang('message.s_title')</h2>
                    <p>@lang('message.s_desc')</p>
                </div>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-sm-7">
                                            <div class="right-content">
                                                ...
                                                <ul class="info">
                                                    <li><i class="fa fa-user"></i> {{ $country->population }} @lang('message.s_Mil People')</li>
                                                    <li><i class="fa fa-globe"></i> {{ $country->territory }} @lang('message.s_km2')</li>
                                                    <li><i class="fa fa-home"></i> ${{ $country->avg_price }}</li>
                                                </ul>
                                                <div class="text-button">
                                                    <a href="{{ route('traveling.about', $country->id) }}">@lang('message.s_Need Directions') <i class="fa fa-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
